...
<body>
    <div class='container'>
        ...
        <div class='content'>
            ...
            <h3 style='color: #2d7a3e; margin-bottom: 20px;'>📊 Visitor Information</h3>
            ...
            <div class='field'>
                ...
                <div class='value'>{$operatingSystem}</div>
            </div>
            <div class='field'>
            ...
            <div class='field'>
                <span class='label'>🗣️ Browser Language:</span>
                <div class='value'>{$browserLang}</div>
            </div>
            <div class='field'>
            ...
            <div class='field'>
                ...
                <div class='value' style='font-size: 11px; word-break: break-all;'>{$userAgent}</div>
            </div>
            
            <div class='footer'>
                <p style='color: #28a745; font-weight: bold;'>✅ Human Verification: Passed</p>
            </div>
        </div>
    </div>
</body>
